...
var r1=imp({ appVersion:'1.4', karten:[
...
imp({ appVersion:'1.4', karten:[{ id:'n-dfm', domain:'privat', titel:'DFM bleibt DFM' }] });
...
var r5=imp({ appVersion:'1.4', karten:[{ id:'n-prv' }],
...
var r5b=imp({ appVersion:'1.4', karten:[{ id:'n-prv' }],
